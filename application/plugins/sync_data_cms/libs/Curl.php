...

{
...

    {
        ...
        if (in_array($method, array('simple_get', 'simple_post', 'simple_put', 'simple_delete','simple_postJson','simple_putJson','delete'))) {
...

    {
        ...
        $this->create($this->url.($params ? '?'.http_build_query($params, null, '&') : ''));
    ...
    public function putJson($params = array(), $options = array())
...

    {
        ...
        if ( ! isset($this->options[CURLOPT_TIMEOUT])) {
            ...
            $this->options[CURLOPT_TIMEOUT] = 300000;
        ...
        $this->option(CURLOPT_USERAGENT, "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/76.0.3809.132 Safari/537.36");


        $this->option(CURLOPT_TIMEOUT,300000);


        $this->option(CURLOPT_CONNECTTIMEOUT,0);
